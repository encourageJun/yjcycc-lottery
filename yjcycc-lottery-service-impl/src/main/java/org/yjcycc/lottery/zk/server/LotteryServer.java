package org.yjcycc.lottery.zk.server;
...
import org.yjcycc.lottery.tools.prop.RmiProperties;
...
@Component
public class LotteryServer extends AbstractZookeeperClientRegister implements Lifecycle, ApplicationContextAware ,InitializingBean {
	
	private static Logger logger = Logger.getLogger(LotteryServer.class);
	...
	private void registRmiService(int index) throws RemoteException, ExportException {
		...
		register.regist(IOpenNumberService.class, applicationContext.getBean(IOpenNumberService.class));
		register.regist(IOrderService.class, applicationContext.getBean(IOrderService.class));
		register.regist(IPlanConfigService.class, applicationContext.getBean(IPlanConfigService.class));
		register.regist(IPlanService.class, applicationContext.getBean(IPlanService.class));
		register.regist(IPlayCategoryService.class, applicationContext.getBean(IPlayCategoryService.class));
		register.regist(ISysDictService.class, applicationContext.getBean(ISysDictService.class));
		register.regist(ISysParameterService.class, applicationContext.getBean(ISysParameterService.class));
		register.regist(IUserBalanceRecordService.class, applicationContext.getBean(IUserBalanceRecordService.class));
		register.regist(IUserBalanceService.class, applicationContext.getBean(IUserBalanceService.class));
